...
describe('CheatCardComponent', () => {
    let component: CheatCardComponent;
    let fixture: ComponentFixture<CheatCardComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(CheatCardComponent);
    ...
    it('should show card for a member', function () {
